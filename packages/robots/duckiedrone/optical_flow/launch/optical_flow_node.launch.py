...
def generate_launch_description():
    ...
    pkg_dir = get_package_share_directory("optical_flow")
    config_file = os.path.join(pkg_dir, "config", "optical_flow_node.yaml")
    ...
    node = Node(
        ...
        remappings=[
            ...
            ("~/projected_motion_vectors", "ground_projection_node/lineseglist_out"),
