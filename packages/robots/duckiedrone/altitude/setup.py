"""Setuptools configuration for the Duckiedrone altitude package."""
...
setup(
    ...
    description="ROS2 altitude package for Duckiedrone.",
    license="Duckietown License",
    tests_require=["pytest"],
    entry_points={
        "console_scripts": [
            "altitude_node = altitude.altitude_node:main",
        ],
    },
)
